...
} from "../dto/workspcae-dto";

interface Props {
  open: boolean;
  onClose: () => void;
  onSubmit: (payload: WorkspaceCreateDto) => Promise<void>;
...
export const WorkspaceDialog = ({
  ...
  const form = useForm({
    ...
    validators: { onSubmit: WorkspaceCreateSchema },
    onSubmit: async ({ value }) => {
      try {
        ...
        toast.error(getApiErrorMessage(error, "Unable to save workspace"));
      }
    },
  });
